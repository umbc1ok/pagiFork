...
execute_process(
  COMMAND "C:/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "0.9.9.8"
  WORKING_DIRECTORY "C:/Users/umbci/source/repos/pagiFork/build/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/umbci/source/repos/pagiFork/build/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/umbci/source/repos/pagiFork/build/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
